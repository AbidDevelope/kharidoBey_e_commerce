                            ...
                            <table class="table v-middle m-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="media-box">
                                                <img src="{{ asset('assets/admin/images/user2.png') }}" class="media-avatar" alt="Bootstrap Themes" />
                                    ...
                                    <tr>
                                        <td>
                                            <div class="media-box">
                                                <img src="{{ asset('assets/admin/images/user5.png') }}" class="media-avatar" alt="Bootstrap Themes" />
                                                <div class="media-box-body">
