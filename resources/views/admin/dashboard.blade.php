                ...
                <div class="card-body">
                    <div class="scroll250">
                        <ul class="recent-orders">
                            <li>
                                <div class="order-img">
                                    <img src="{{ asset('assets/admin/images/food/img1.jpg') }}" alt="Bootstrap Gallery">
                            ...
                            <li>
                                <div class="order-img">
                                    <img src="{{ asset('assets/admin/images/food/img3.jpg') }}" alt="Bootstrap Gallery">
                            ...
                            <li>
                                <div class="order-img">
                                    <img src="{{ asset('assets/admin/images/food/img4.jpg') }}" alt="Bootstrap Gallery">
                            ...
                            <li>
                                <div class="order-img">
                                    <img src="{{ asset('assets/admin/images/food/img5.jpg') }}" alt="Bootstrap Gallery">
                            ...
                            <li>
                                <div class="order-img">
                                    <img src="{{ asset('assets/admin/images/food/img6.jpg') }}" alt="Bootstrap Gallery">
                            ...
                            <li>
                                <div class="order-img">
                                    <img src="{{ asset('assets/admin/images/food/img2.jpg') }}" alt="Bootstrap Gallery">
