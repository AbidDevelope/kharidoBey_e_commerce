              ...
              <div class="col-lg-6 col-md-10">
                <div class="card card-default mb-0">
                  ...
                  <div class="card-body px-5 pb-5 pt-0">
                    ...
                    <h4 class="text-dark mb-6 text-center">Enter your email address and we will send you a link to reset your password. </h4>

                    <form action="{{ route('forgot.password.submit') }}" method="POST">
                        @csrf
                      <div class="row">
                        <div class="form-group col-md-12 mb-4">
                            <input type="email" name="email" value="{{ old('email') }}" class="form-control input-lg" placeholder="Enter your email" >
                    @if($errors->has('email'))
