                            ...
                            <div class="card h-320">
                                ...
                                <div class="card-body">
                                    <div class="top-items-container">
                                        <div id="topRatedItems" class="carousel carousel-fade slide"
                                            data-bs-ride="carousel">
                                            <div class="carousel-inner">
                                                <div class="carousel-item active">
                                                    <img src="assets/images/food/img6.jpg"
                                                        class="img-fluid top-item-img"
                                                ...
                                                <div class="carousel-item">
                                                    <img src="assets/images/food/img7.jpg"
                                                        class="img-fluid top-item-img"
                                                        alt="Best Admin Dashboards">
                                                    <div class="top-item-details">
                                                        <h6>Burger Fries</h6>
                                                ...
                                                <div class="carousel-item">
                                                    <img src="assets/images/food/img2.jpg"
                                                        class="img-fluid top-item-img"
                                                        alt="Best Admin Dashboards">
                                                    <div class="top-item-details">
                                            ...
                                            <a class="carousel-control-prev" href="#topRatedItems"
                                                role="button" data-bs-slide="prev">
                                                <span class="carousel-control-prev-icon"
                                                    aria-hidden="true"></span>
                                            </a>
                                            <a class="carousel-control-next" href="#topRatedItems"
                                                ...
                                                <div class="log-details">
                                                    ...
                                                    <div class="stacked-images mt-1">
                                                        <img class="sm" src="assets/images/user5.png"
                                                            alt="Admin Dashboards">
                                                        <img class="sm" src="assets/images/user.png"
                                                            alt="Admin Dashboards">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <ul class="customer-rating">
                                        <li class="clearfix">
                                            <div class="customer">
                                                <img src="assets/images/user2.png" alt="Vivo Admin">
                                            </div>
                                        ...
                                        <li class="clearfix">
                                            <div class="customer">
                                                <img src="assets/images/user3.png" alt="Vivo Admin">
                                            </div>
                                            <div class="customer-review">
                                            ...
                                            <div class="poll-block-header">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label"
                                                        for="inlineRadio1">Angular</label>
                                                </div>
                                ...
                                <div class="card-body">
                                    <div class="scroll370">
                                        <ul class="recent-orders">
                                            ...
                                            <li>
                                                <div class="order-img">
                                                    <img src="assets/images/food/img4.jpg"
                                                        alt="Bootstrap Gallery">
                                                    <span class="badge bg-primary">Delivered</span>
                                                </div>
                                                <div class="order-details">
                                        ...
                                        <ul class="chats">
                                            <li class="chats-left">
                                                <div class="chats-avatar">
                                                    <img src="assets/images/user.png" alt="Vivo Admin">
                                                ...
                                                <div class="chats-hour">08:55 <span
                                                        class="icon-done_all"></span></div>
                                            </li>
                                            <li class="chats-right">
                                                <div class="chats-avatar">
                                                    <img src="assets/images/user6.png" alt="Vivo Admin">
                                                ...
                                                <div class="chats-hour">08:56 <span
                                                        class="icon-done_all"></span></div>
                                            </li>
                                            <li class="chats-left">
                                                <div class="chats-avatar">
                                                ...
                                                <div class="chats-hour">08:57 <span
                                                        class="icon-done_all"></span></div>
                                            </li>
                                            <li class="chats-right">
                                                <div class="chats-avatar">
                                                ...
                                                <div class="chats-text">Lorem Ipsum's origins extend far
                                                    ...
                                                    middle ages.</div>
                                                <div class="chats-hour">08:59 <span
                                                        class="icon-done_all"></span></div>
                                            </li>
                                            <li class="chats-left">
                                                <div class="chats-avatar">
                                                ...
                                                <div class="chats-hour">09:00 <span
                                                        class="icon-done_all"></span></div>
                                            </li>
                                            <li class="chats-right">
                                                <div class="chats-avatar">
                                            ...
                                            <li class="chats-left">
                                                ...
                                                <div class="chats-hour">09:01 <span
                                                        class="icon-done_all"></span></div>
                                            </li>
                                            <li class="chats-right">
                                                <div class="chats-avatar">
