                                            ...
                                            <div class="col-sm-6 col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="title"
                                                        id="title" placeholder="Enter Product Name" value="{{ $products->title }}">
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input readonly type="text" class="form-control"
                                                        name="slug" id="slug" value="{{ $products->slug }}"
                                            ...
                                            <div class="col-sm-12 col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea type="text" class="form-control" placeholder="Enter Short Description" name="short_description"
                                                        id="short_description" rows="2" >{{ $products->short_description }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea type="text" class="form-control" placeholder="Enter Long Description" name="long_description"
                                                        id="long_description" rows="3" >{{ $products->long_description }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="col-sm-6 col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="selling_price"
                                                        id="selling_price" value="{{ $products->selling_price }}" placeholder="Enter Product Price">
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="old_price"
                                                        id="old_price" value="{{ $products->old_price }}" placeholder="Enter Product Price">
                                                </div>
                                            </div>
                                            <div class="col-sm-6 col-12">
                                                <div class="mb-3">
                                                    <label class="form-label">Product Compare Price <span
                                                            class="text-red">*</span></label>
                                                    <input type="text" class="form-control" name="compare_price" value="{{ $products->compare_price }}"
                                            ...
                                            <div class="col-sm-6 col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="stock" class="form-control"
                                                        id="stock" placeholder="Enter Product Stock" value="{{ $products->stock }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <select class="form-control" name="category_id"
                                                        ...
                                                        @foreach($category as $categories)
                                                            <option value="{{ $categories->id }}" {{ $products->category_id == $categories->id ? 'selected' : '' }}>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <select class="form-control" name="sub_category_id"
                                                        ...
                                                        @foreach($subcategories as $subcat)
                                                          <option value="{{ $subcat->id }}" {{ $products->sub_category_id == $subcat->id ? 'selected' : '' }}>{{ $subcat->name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <select class="form-control" name="brand_id" id="brand_id">
                                                        ...
                                                        @foreach($brands as $brand)
                                                            <option value="{{ $brand->id }}" {{ $products->brand_id == $brand->id ? 'selected' : '' }}>{{ $brand->name }}
                                                            </option>
                                                        @endforeach 
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-sm-12 col-12">
                                                <div class="mb-3">
                                                    ...
                                                    <select class="form-control" name="is_featured"
                                                        ...
                                                        <option value="Yes" {{ $products->is_featured == 'Yes' ? 'selected' : '' }}>{{ $products->is_featured }}</option>
                                                        <option value="No" {{ $products->is_featured == 'No' ? 'selected' : '' }}>{{ $products->is_featured }}</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
